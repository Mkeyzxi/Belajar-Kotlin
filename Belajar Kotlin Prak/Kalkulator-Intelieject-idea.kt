...
fun main() {
    ...
    do{
        print("Silahkan masukkan variabel 1 : ")
        var varSatu: Int? = readLine()?.toIntOrNull() ?: 0
        print("Silahkan masukkan variabel 2 : ")
        var varDua: Int? = readLine()?.toIntOrNull() ?: 0
        ...
        when (pilihan) {
            "1" -> {
                ...
                println("0. Keluar")
                print("Pilihan anda : ")
                var pilihan2: String? = readLine() ?: "0"
                Cetak(varSatu ?: 0, varDua ?: 0, pilihan ?: "0", pilihan2 ?: "0")
            }
            "2" -> {
                println("1. Median")
                println("2. Akar kuadrat")
